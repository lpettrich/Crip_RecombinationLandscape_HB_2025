...
write.table(dfm_mean, "HB_rho_distance_mean_broad_1kb.csv", sep = "'")
#######################################################################################
# DECAY PLOTS
#######################################################################################
...
cowplot::save_plot("~/sciebo/RecombinationLandscape_CRIP/02_Revision_2/BMC_Genomics_CripRecLand/Revision_20250820/NewResults/DecayPlot_HB_rho_1kb_broad.png", c1.1, base_asp = 1.9, dpi = 500, bg = "white")
cowplot::save_plot("~/sciebo/RecombinationLandscape_CRIP/02_Revision_2/BMC_Genomics_CripRecLand/Revision_20250820/NewResults/DecayPlot_HB_rho_1kb_broad.svg", c1.1, base_asp = 1.9, dpi = 500, bg = "white")
