...
files_to_read = list.files(
  path = "/Users/laupe/Downloads/",        # directory to search within
...
p <- p + theme(axis.text.x = element_text(size = 14, color = "black", angle = -90, hjust = 1))

cowplot::save_plot("C:/Users/laupe/Documents/sciebo/RecombinationLandscape_CRIP/02_Revision_2/BMC_Genomics_CripRecLand/New_Results/Cla_all.svg", 
                   p,nrow = 2, ncol = 6, base_asp = 1.3, dpi = 600, bg = "white", scale = 0.7)
cowplot::save_plot("C:/Users/laupe/Documents/sciebo/RecombinationLandscape_CRIP/02_Revision_2/BMC_Genomics_CripRecLand/New_Results/Cla_all.png", 
                   p, nrow = 2, ncol = 6, base_asp = 1.3, dpi = 600, bg = "white", scale = 0.7)

# How large are the insertions?
size_cla <- genes %>%
  mutate(geneEnd = geneEnd * 1e6,
         geneStart = geneStart * 1e6) %>%
...
library(cowplot)
#save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DensityPlot_v1.svg", h, ncol = 1.5, nrow = 2, base_asp = 2, dpi = 500, bg = "white")
#save_plot("~/sciebo/RecombinationLandscape_CRIP/01_Revison/NewResults/Plots/DensityPlot_v1.png", h, ncol = 1.5, nrow = 2, base_asp = 2, dpi = 500, bg = "white")
